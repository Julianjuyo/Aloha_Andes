--CREACION TABLA ALOJAMIENTOS y especificaci�n de sus restricciones
...
ALTER TABLE ALOJAMIENTOS
    ...
    ADD CONSTRAINT CK_HABILITADO
        CHECK (HABILITADO IN ('Y', 'N'))
...
--CREACION TABLA OPERADORES y especificaci�n de sus restricciones
...
--CREACION TABLA SERVICIOS  y especificaci�n de sus restricciones
...
--CREACION TABLA VIVIENDA COMUNIDAD y especificaci�n de sus restricciones
...
--CREACION TABLA HABITACIONES y especificaci�n de sus restricciones
...
--CREACION TABLA MIEMBROS COMUNIDAD UNIVERCITARIA y especificaci�n de sus restricciones--
...
--CREACION RESERVAS y especificaci�n de sus restricciones--
...
--CREACION APARTAMENTOS y especificaci�n de sus restricciones--
CREATE TABLE APARTAMENTOS
            ( IDALOJAMIENTO NUMBER,
              DIRECCION VARCHAR(255) NOT NULL,
              PRECIO NUMBER NOT NULL,
              DUENO NUMBER NOT NULL,
